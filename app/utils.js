...
const TRANSLATIONS = {
  en: {
    ...
    'section-play': '🎮 Play & Explore',
    'section-journal': '📖 Journaling & Tracking',
    'section-prep': '🧘 Preparation & Analysis',
    // ── Intuition Dice ──
    'dice-title': 'Intuition Dice',
    'dice-desc': 'A quick psychic check-in. Focus on a number, roll the dice, and see if your intuition can influence the outcome.',
    'dice-desc-hub': 'Focus on a number, roll the dice, see if your intuition influenced the outcome.',
    'dice-how-title': 'How It Works',
    'dice-step1': 'Pick a number from 1 to 6 in your mind',
    'dice-step2': 'Tap the dice to roll — focus on your number',
    'dice-step3': 'See if your intuition influenced the result',
    'dice-step4': 'Track your streak and accuracy over time',
    'dice-tip1': 'Relax and let your intuition guide you. Don\'t force it — just feel.',
    'dice-total-rolls': 'Total Rolls',
    'dice-hits': 'Hits',
    'dice-accuracy': 'Accuracy',
    'dice-best-streak': 'Best Streak',
    'dice-roll-btn': '🎲 Roll the Dice',
    'dice-focus-title': 'Focus on Your Number',
    'dice-focus-desc': 'Think of a number from 1 to 6. Then tap the dice to roll.',
    'dice-tap-roll': 'Tap the dice to roll',
    'dice-hit-title': '🎯 Connection!',
    'dice-miss-title': '🎲 No Match',
    'dice-your-number': 'Your number was:',
    'dice-dice-showed': 'The dice showed:',
    'dice-roll-again': '🎲 Roll Again',
    'dice-history-title': '📊 Roll History',
    // ── Color Sense ──
    'color-title': 'Color Sense',
    'color-desc': 'A color flashes briefly — can your inner eye see it?',
    'color-desc-hub': 'A color flashes briefly — can your inner eye see it?',
    'color-how-title': 'How It Works',
    'color-step1': 'A color fills the screen briefly',
    'color-step2': 'It disappears — close your eyes and sense it',
    'color-step3': 'Pick the color you sensed from the palette',
    'color-step4': 'Track your clairvoyance accuracy',
    'color-tip1': 'Don\'t try to remember — try to sense it from within.',
    'color-total-rounds': 'Rounds',
    'color-hits': 'Hits',
    'color-accuracy': 'Accuracy',
    'color-level': 'Level',
    'color-start-btn': '🎨 Start',
    'color-waiting': 'Getting ready...',
    'color-guess-title': 'What color did you sense?',
    'color-guess-desc': 'Close your eyes, sense it, then tap your answer.',
    'color-actual': 'Actual',
    'color-sensed': 'You Sensed',
    'color-hit-title': '🎯 Perfect Vision!',
    'color-miss-title': '🎨 Close, Keep Going!',
    'color-next-btn': '🎨 Next Round',
    // ── Mind Reader ──
    'mind-title': 'Mind Reader',
    'mind-desc': 'A solo telepathy challenge. Think of a symbol, then try to read your own mind a moment later.',
    'mind-desc-hub': 'Think of a symbol, then try to read your own mind a moment later.',
    'mind-how-title': 'How It Works',
    'mind-step1': 'Pick a symbol and focus on it intensely',
    'mind-step2': 'The screen clears — send the image to your subconscious',
    'mind-step3': 'Try to "read" what symbol you chose',
    'mind-step4': 'See if your mind can transmit to itself',
    'mind-tip1': 'Focus on the feeling of the symbol, not its name.',
    'mind-total-rounds': 'Rounds',
    'mind-hits': 'Hits',
    'mind-accuracy': 'Accuracy',
    'mind-best-streak': 'Best Streak',
    'mind-start-btn': '🧠 Start Round',
    'mind-pick-title': 'Choose a Symbol',
    'mind-pick-desc': 'Tap one — then focus on it with all your mind.',
    'mind-focus-text': 'Focus on this symbol...',
    'mind-focus-sub': 'Send it deep into your mind',
    'mind-ready-btn': 'I\'m Ready to Read',
    'mind-read-title': 'What symbol do you sense?',
    'mind-read-desc': 'Don\'t think — just tap what comes to mind.',
    'mind-sent': 'Sent',
    'mind-received': 'Received',
    'mind-hit-title': '🧠 Mind Connected!',
    'mind-miss-title': '🧠 Signal Faded',
    'mind-next-btn': '🧠 Next Round',
    // ── Focus Orb ──
    'orb-title': 'Focus Orb',
    'orb-desc': 'A concentration exercise. Keep your focus on the orb — how long can you maintain it?',
    'orb-desc-hub': 'A concentration exercise — how long can you maintain focus?',
    'orb-how-title': 'How It Works',
    'orb-step1': 'Stare at the glowing orb without blinking',
    'orb-step2': 'The orb will drift — follow it with your eyes',
    'orb-step3': 'When you lose focus, tap to reset',
    'orb-step4': 'Beat your best focus time',
    'orb-tip1': 'Sustained focus is the foundation of all psychic abilities.',
    'orb-sessions': 'Sessions',
    'orb-best': 'Best Time',
    'orb-avg': 'Average',
    'orb-total': 'Total Focus',
    'orb-start-btn': '🔮 Begin Focus',
    'orb-focus-label': 'Focus Time',
    'orb-tap-lose': 'Tap if you lose focus',
    'orb-end-btn': 'End Session',
    'orb-focus-duration': 'Focus Duration',
    'orb-again-btn': '🔮 Try Again',
    // ── Energy Pulse ──
    ...
    'pulse-step3': 'See how close your sense was to the actual peak',
    'pulse-step4': 'Train your sensitivity to subtle energy shifts',
    'pulse-tip1': 'Don\'t watch for the pulse — feel it in your body.',
    'pulse-rounds': 'Rounds',
    'pulse-perfect': 'Perfect',
    'pulse-avg-offset': 'Avg Offset',
    'pulse-level': 'Level',
    'pulse-start-btn': '⚡ Start Pulse',
    'pulse-instruction': 'Close your eyes. Feel the pulse. Tap when it peaks.',
    'pulse-tap-btn': '⚡ I Feel It!',
    'pulse-offset': 'Offset from peak',
    'pulse-next-btn': '⚡ Next Pulse',
  ...
  he: {
    ...
    'section-play': '🎮 משחק וגילוי',
    'section-journal': '📖 יומן ומעקב',
    'section-prep': '🧘 הכנה וניתוח',
    // ── Intuition Dice ──
    'dice-title': 'קוביית אינטואיציה',
    'dice-desc': 'בדיקה פסיכית מהירה. התמקד במספר, הקפץ קוביה, וראה אם האינטואיציה שלך השפיעה.',
    'dice-desc-hub': 'התמקד במספר, הקפץ קוביה, ראה אם האינטואיציה שלך השפיעה.',
    'dice-how-title': 'איך זה עובד',
    'dice-step1': 'בחר מספר בין 1 ל-6 בראש שלך',
    'dice-step2': 'גע בקוביה כדי להקפיץ — התמקד במספר שלך',
    'dice-step3': 'ראה אם האינטואיציה שלך השפיעה על התוצאה',
    'dice-step4': 'עקוב אחר רצף והדיוק לאורך זמן',
    'dice-tip1': 'הירגע ותן לאינטואיציה שלך להוביל.',
    'dice-total-rolls': 'סה"כ הקפצות',
    'dice-hits': 'פגיעות',
    'dice-accuracy': 'דיוק',
    'dice-best-streak': 'רצף הטוב ביותר',
    'dice-roll-btn': '🎲 הקפץ קוביה',
    'dice-focus-title': 'התמקד במספר שלך',
    'dice-focus-desc': 'חשוב על מספר בין 1 ל-6. אחר כך גע בקוביה.',
    'dice-tap-roll': 'גע בקוביה כדי להקפיץ',
    'dice-hit-title': '🎯 חיבור!',
    'dice-miss-title': '🎲 אין התאמה',
    'dice-your-number': 'המספר שלך היה:',
    'dice-dice-showed': 'הקוביה הראתה:',
    'dice-roll-again': '🎲 הקפץ שוב',
    'dice-history-title': '📊 היסטוריית הקפצות',
    // ── Color Sense ──
    'color-title': 'תחושת צבע',
    'color-desc': 'צבע מופיע לרגע — האם העין הפנימית שלך יכולה לראות אותו?',
    'color-desc-hub': 'צבע מופיע לרגע — האם העין הפנימית שלך יכולה לראות אותו?',
    'color-how-title': 'איך זה עובד',
    'color-step1': 'צבע ממלא את המסך לרגע',
    'color-step2': 'הוא נעלם — סגור עיניים והרגש אותו',
    'color-step3': 'בחר את הצבע שהרגשת מהפלטת צבעים',
    'color-step4': 'עקוב אחר דיוק הקליירבוינס שלך',
    'color-tip1': 'אל תנסה לזכור — נסה להרגיש מבפנים.',
    'color-total-rounds': 'סיבובים',
    'color-hits': 'פגיעות',
    'color-accuracy': 'דיוק',
    'color-level': 'רמה',
    'color-start-btn': '🎨 התחל',
    'color-waiting': 'מתכונן...',
    'color-guess-title': 'איזה צבע הרגשת?',
    'color-guess-desc': 'סגור עיניים, הרגש, ואחר כך גע בתשובה.',
    'color-actual': 'ממש',
    'color-sensed': 'הרגשת',
    'color-hit-title': '🎯 ראייה מושלמת!',
    'color-miss-title': '🎨 קרוב, המשך!',
    'color-next-btn': '🎨 סיבוב הבא',
    // ── Mind Reader ──
    'mind-title': 'קורא מחשבות',
    'mind-desc': 'אתגר טלפתיה בודד. חשב על סמל, ואז נסה לקרוא את המחשבה שלך רגע אחר כך.',
    'mind-desc-hub': 'חשב על סמל, ואז נסה לקרוא את המחשבה שלך רגע אחר כך.',
    'mind-how-title': 'איך זה עובד',
    'mind-step1': 'בחר סמל והתמקד בו בעוצמה',
    'mind-step2': 'המסך מתנקה — שלח את התמונה לתת-המודעות',
    'mind-step3': 'נסה "לקרוא" איזה סמל בחרת',
    'mind-step4': 'ראה אם המחשבה שלך יכולה לשדר לעצמה',
    'mind-tip1': 'התמקד בתחושה של הסמל, לא בשמו.',
    'mind-total-rounds': 'סיבובים',
    'mind-hits': 'פגיעות',
    'mind-accuracy': 'דיוק',
    'mind-best-streak': 'רצף הטוב ביותר',
    'mind-start-btn': '🧠 התחל סיבוב',
    'mind-pick-title': 'בחר סמל',
    'mind-pick-desc': 'גע באחד — אחר כך התמקד בו בכל המחשבה שלך.',
    'mind-focus-text': 'התמקד בסמל הזה...',
    'mind-focus-sub': 'שלח אותו עמוק לתוך המחשבה שלך',
    'mind-ready-btn': 'אני מוכן לקרוא',
    'mind-read-title': 'איזה סמל אתה מרגיש?',
    'mind-read-desc': 'אל תחשוב — פשוט גע במה שעולה לראש.',
    'mind-sent': 'נשלח',
    'mind-received': 'התקבל',
    'mind-hit-title': '🧠 מחשבה התחברה!',
    'mind-miss-title': '🧠 האות דעך',
    'mind-next-btn': '🧠 סיבוב הבא',
    // ── Focus Orb ──
    'orb-title': 'כדור ריכוז',
    'orb-desc': 'תרגיל ריכוז. שמור את המיקוד על הכדור — כמה זמן תוכל להחזיק?',
    'orb-desc-hub': 'תרגיל ריכוז — כמה זמן תוכל לשמור מיקוד?',
    'orb-how-title': 'איך זה עובד',
    'orb-step1': 'התבונן בכדור הזוהר בלי להבהב',
    'orb-step2': 'הכדור יתנדנד — עקוב אחריו בעיניים',
    'orb-step3': 'כשאתה מאבד מיקוד, גע לאפס',
    'orb-step4': 'תשבור את שיא הריכוז שלך',
    'orb-tip1': 'ריכוז מתמשך הוא הבסיס לכל היכולות הפסיכיות.',
    'orb-sessions': 'סשנים',
    'orb-best': 'זמן שיא',
    'orb-avg': 'ממוצע',
    'orb-total': 'סה"כ ריכוז',
    'orb-start-btn': '🔮 התחל ריכוז',
    'orb-focus-label': 'זמן ריכוז',
    'orb-tap-lose': 'גע אם אתה מאבד מיקוד',
    'orb-end-btn': 'סיום סשן',
    'orb-focus-duration': 'משך ריכוז',
    'orb-again-btn': '🔮 נסה שוב',
    // ── Energy Pulse ──
    ...
    'pulse-step3': 'ראה כמה קרוב התחושה שלך לשיא האמיתי',
    'pulse-step4': 'אמן את הרגישות שלך לשינויים עדינים באנרגיה',
    'pulse-tip1': 'אל תחכה לפולס — הרגש אותו בגוף שלך.',
    'pulse-rounds': 'סיבובים',
    'pulse-perfect': 'מושלם',
    'pulse-avg-offset': 'סטייה ממוצעת',
    'pulse-level': 'רמה',
    'pulse-start-btn': '⚡ התחל פולס',
    'pulse-instruction': 'סגור עיניים. הרגש את הפולס. גע כשהוא בשיא.',
    'pulse-tap-btn': '⚡ אני מרגיש!',
    'pulse-offset': 'סטייה מהשיא',
    'pulse-next-btn': '⚡ פולס הבא',
