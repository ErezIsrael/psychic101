...
const TRANSLATIONS = {
  ...
  he: {
    ...
    'dial-save': '💾 שמור סשן',
    'about-page': '— אודות',
    'about-hero-title': 'ערכת הפיתוח הפסיכית שלך',
    ...
    'about-what-desc': 'Psychic101 הוא אוסף כלים לתרגול בדפדפן לחקר תפיסה חושי-חויה (ESP), ראייה מרחוק, ותופעות פסיכיות קשורות. כל אפליקציה מתמקדת במיומנות ספציפית, מתרגול קלפי זנר קלאסי ועד פרוטוקול CRV מלא.',
